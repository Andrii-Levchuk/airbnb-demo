		...
		<div>
			...
			<main className='max-w-7xl mx-auto px-8 sm:px-16'>
				...
				<section>
					...
					<div className='flex space-x-3 overflow-scroll scrollbar-hide p-3 -m3-3'>
						{cardsData?.map(item => (
				...
				<LargeCard image='https://links.papareact.com/4cj' 
